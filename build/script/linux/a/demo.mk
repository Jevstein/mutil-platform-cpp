...
### 1.CONFIG
DEBUG		 = YES
APP_NAME     = calc_a_demo
APP_OUT      = $(APP_NAME)
APP_OUTS     = $(APP_NAME)
ROOT_DIR	 = ../../../..
OUT_DIR      = $(ROOT_DIR)/bin/linux
OBJ_DIR		 = $(ROOT_DIR)/bin/obj/linux/demo_a
INCS_DIR	 = $(ROOT_DIR)/include
LIBS_DIR	 = $(ROOT_DIR)/lib/linux/a
LIBS		 = -L$(LIBS_DIR) -lcalc_sdk
VPATH		 = $(ROOT_DIR)/sample/linux/calc_a_demo
SRCS		 = $(wildcard $(ROOT_DIR)/sample/linux/calc_a_demo/*.cpp)
