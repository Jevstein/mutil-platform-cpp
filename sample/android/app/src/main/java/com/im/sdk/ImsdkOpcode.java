...
//    kNotiAddRobotInfo 					(215), //群组邀请成功通知，通知所有群成员 通知
//    kNotiRemoveRobotInfo 				(216), //移除机器人 通知
//    kNotiUpdateRobotInfo 				(217), //更新机器人 通知
//
//    //群组消息相关通知(250-299)
...
//    kNotiSendMsg						(306), //发送通知消息 通知
//
//    //会话相关通知(350-399;
//    kNotiSetSingleChatReadStatus 		(350), //设置单聊会话阅读状态 通知
//    kNotiSetGroupChatReadStatus 		(351), //设置群组聊天会话阅读状态 通知
//    kNotiSetHGroupChatReadStatus 		(352), //设置客户群组聊天会话阅读状态 通知
//    kNotiSetSingleChatTopStatus			(353), //设置单聊会话置顶状态 通知
//    kNotiSetGroupChatTopStatus 			(354), //设置群聊会话置顶状态 通知
//    kNotiSetHGroupChatTopStatus 		(355), //设置客户群聊会话置顶状态 通知
//    kNotiSetSysGroupChatTopStatus		(356), //设置系统消息会话置顶状态 通知
//    kNotiSetCommonChatTopStatus 		(357), //设置其他通用会话置顶状态 通知
//
//    //消息提醒设置相关通知(400-449)
...
public enum ImsdkOpcode {
    ...
    //------------------ 用户信息 ------------------
    kOPGetCidUserInfo 					(1051), //按cid获取用户信息列表
    kOPGetUserInfo 						(1052), //根据cid、uid获取用户信息
    kOPGetCustomInfo 					(1053), //获取客户信息
    ...
    kOPAddRobotInfo 					(1226), //添加自定义机器人 - 通知
    kOPRemoveRobotInfo 					(1227), //移除机器人 - 通知
    kOPUpdateRobotInfo 					(1228), //更新机器人信息
    kOPGetRobotDetail 					(1229), //获取机器人用户信息详情
    ...
    /*群聊相关-80*/
    kOPSendGroupMsg 					(1341), //发送群消息 - 通知
    kOPGetGroupMsgByMsgid 				(1342), //指定msgid获取群消息
    kOPGetGroupMsgByKind 				(1343), //指定kind获取群消息
    kOPGetGroupMsgByPage 				(1344), //分页获取群消息
    kOPGetGroupMsg 						(1345), //获取群消息
    kOPSetGroupMsgReadStatus 			(1346), //标记群消息已读
    ...
    /*单聊相关-80*/
    kOPSendSingleMsg 					(1421), //发送单聊消息
    kOPGetSingleMsgByMsgid 				(1422), //指定msgid获取单聊消息(sdk内部使用)
    kOPGetSingleMsgByKind 				(1423), //指定kind获取单聊消息
    kOPGetSingleMsgByPage 				(1424), //分页获取单聊消息
    kOPGetSingleMsg 					(1425), //获取单聊消息
    kOPSetSingleMsgReadStatus 			(1426), //标记单聊消息已读
    ...
    kOPSetSysMsgReadStatus	    		(1504), //标记系统消息已读 - 通知
    kOPSetSysMsgUnReadStatus	    	(1505), //标记系统消息未读 - 通知
    kOPSendCommMsg	    				(1506), //发送公共消息 - 通知
    kOPSendNoticeMsg	    			(1507), //发送通知消息 - 通知
    kOPGetSysGroupInfo	    			(1508), //获取系统分组信息

    //------------------ 外部联系人 ------------------
    kOPApplyFriend 					    (1601), //申请加为好友 - 通知
    kOPReplyFriend 					    (1602), //好友申请回复 - 通知
    kOPGetFriendList 				    (1603), //获取好友列表
    kOPSearchUserRelationInfo 		    (1604), //搜索外部联系人用户关系信息
    kOPRemoveFriend 				    (1605), //解除好友关系 - 通知
    kOPGetFriendRelation 			    (1606), //获取用户好友关系

    //------------------ 消息免打扰 ------------------
    kOPSetMsgRemind	    				(1651), //设置消息免打扰信息 - 通知
    kOPSetTaskSysMsgRemind	    		(1652), //设置任务系统消息免打扰信息
    kOPGetTaskSysMsgRemind	    		(1653), //获取任务系统消息免打扰信息
    kOPSetMsgRemindTime     			(1654), //设置时间段消息免打扰信息 - 通知
    ...
    /*app push开关*/
    kOPSetAppPush 			    		(1951), //设置app push开关 - 通知
    kOPGetAppPush			    		(1952), //拉取app push开关

    /*透传协议*/
    kOPTransportTech			    	(1955), //多人透传协议 - 通知
    kOPGroupTransportTech			    (1956), //多群透传协议 - 通知
