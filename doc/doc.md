...
###  6.1. <a name='c.a'></a>编译链接c++静态库.a文件
* step1:  
...
* step3:  
添加源代码，右键点击项目，在展开的右键菜单中选择“Add Files to...", 选择指定的目录，请务必勾选“Create Groups”和“copy items if needs”, 如图: ![图3](images\ios\a.3.png)  



将红框标注的地方改成“iOS Device”，这样我们可以编译一个真机的静态库将红框标注的地方改成任一模拟器，如“iPhone 6”，就能编译一个模拟器用的静态库
展开“Products”菜单，点击“Build”进行编译
按住Comand + B进行编译
编译成功后，展开“Products”节点，右键选择刚刚生成的静态库“libmecli.a”，在右键菜单中选择“Show in Finder”可以找到该静态库文件



####  6.1.1. <a name='xcode.a'></a>利用Xcode生成c++静态库.a文件的步骤方法
* 操作步骤：  

####  6.1.2. <a name='c.a-1'></a>objective-c加载c++静态库.a文件的步骤方法
* 操作步骤：  

####  6.1.3. <a name='c.a-1'></a>遇到的问题及解决方法
* 1.copy items if needs
* 

###  6.2. <a name='c.a'></a>打包c++静态或动态库.framework文件